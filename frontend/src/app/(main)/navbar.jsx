...
const Navbar = () => {
  return (
    <div>
      <nav className=" bg-[#1E2852] border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            ...
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">
              <div className="text-[#FFFFFF]">VOX-MARKET</div>
            </span>
          </a>
          ...
          >
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-[#1E2852] dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <Link
                  href="/"
